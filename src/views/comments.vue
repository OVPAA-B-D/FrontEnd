<template>
  ...
  <div class=" bg-white shadow-3xl flex flex-col  h-min w-25 p-2 rounded-xl">
      <div class="flex justify-between">
          ...
          <h1 class="text-blue-150 text-xl font-bold">Leni Mercedez</h1>
          <h1 class="text-yellow-150 text-sm">Internal Accreditor</h1>
          </div>
      </div>
  ...
  <div class=" bg-white shadow-3xl flex flex-col  h-min w-25 p-2 rounded-xl">
      <div class="flex justify-between">
          ...
          <div class="flex flex-col">
          <h1 class="text-blue-150 text-xl font-bold">Jonny Sins</h1>
          <h1 class="text-yellow-150 text-sm">Internal Accreditor</h1>
          </div>
      </div>
      <div class="flex items-end flex-col text-xs text-gray-150">
